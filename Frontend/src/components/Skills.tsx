...
const Skills = () => {
  return (
    <>
      <section className="text-white flex flex-col md:max-w-2xl main_2 p-3">
          <h3 className="text-2xl text-center m-2"><span className="border-b-2 border-[#ffb401] pb-1 px-3">My Skills</span></h3>
